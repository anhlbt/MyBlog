...
(function() {
  ...
  return (function() {
      ...
      1: [function(require, module, exports) {
              var audioSync = function(options) {
                ...
                //   var subtitles = document.getElementById(options.subtitlesContainer);
                  var audioPlayer = document.querySelector(options.audioPlayer);
                  var subtitles = document.querySelector(options.subtitlesContainer);
                  var syncData = [];
                  var rawSubTitle = "";
                  var convertVttToJson = require('vtt-json');
                  console.log("subtitleFiel: ",options.subtitlesFile)  
                  var init = function() {
                  ...
                  function createSubtitle(text) {
                      ...
                      convertVttToJson(text)
                          .then((result) => {
                              console.log("createSubtile: ",result)
                              var x = 0;
              ...
              console.log("hello there...............", typeof(audioSync))
      ...
      2: [function(require, module, exports) {
          ...
          console.log("hello there typeof convertVttToJson", typeof(convertVttToJson))
