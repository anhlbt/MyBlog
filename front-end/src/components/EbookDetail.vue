      ...
      <div class="col-lg-12">
        ...
        <article v-if="post" class="g-mb-30 g-pt-15 g-pb-15">
          ...
          <div id="postBody" class="g-font-size-16 g-line-height-1_8 g-mb-30">
            ...
            <!-- vue-markdown begins to parse markdown, it is a sub-component, you can pass it a value through props
             To specify the TOC level, if you want to modify the TOC style, you must operate in the function specified by toc-rendered, because you have to wait for it to create the TOC
              -->
            <!-- <vue-markdown
              :source="post.summary + '\n'+post.body"
              :toc="showToc"
          ...
          <div>         
            ...
            <EbookTest v-bind:json_ebook="post.json_book['fragments']" v-bind:audio_file="require(`../assets/Elementary/${post.title}.mp3`)"></EbookTest>
        ...
        <div class="g-mb-60">
          <ul class="list-inline d-sm-flex mb-0">
            <li v-bind:class="{'u-pagination-v1__item--disabled': !post.prev_id}" class="list-inline-item g-hidden-xs-down" data-toggle="tooltip" data-placement="top" title="" v-bind:data-original-title="post.prev_title || ''">
              <router-link v-bind:to="{ name: 'EbookDetail', params: { id: post.prev_id || 0 } }" class="u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16" href="#" aria-label="Previous">
            ...
            <li v-bind:class="{'u-pagination-v1__item--disabled': !post.next_id}" class="list-inline-item ml-auto g-hidden-xs-down" data-toggle="tooltip" data-placement="top" title="" v-bind:data-original-title="post.next_title || ''">
              <router-link router-link v-bind:to="{ name: 'EbookDetail', params: { id: post.next_id || 0 } }" class="u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16" href="#" aria-label="Next">
                <span aria-hidden="true">
        ...
        <div id="comment-list-wrap" class="card border-0 g-mb-15">
          ...
          <div v-if="comments" class="card-block g-pa-0" >
            ...
            <!-- First-level comments, arranged in reverse chronological order -->
            <div v-for="(comment, index) in comments.items" v-bind:key="index">
              ...
              <!-- Child comments, arranged in chronological order -->
...
// import adata from '../assets/audio/a3.json'
// var syncData= adata['fragments']
// console.log(syncData[10]['lines'])

import store from '../store'
// Import vue-markdown component to parse markdown, the original text is 　HTML
import VueMarkdown from 'vue-markdown'
//Paging subcomponent
import Pagination from './Base/Pagination'
// After the vue-router is routed from the Home page to the Post page, it will be re-rendered and the event will be removed, and the custom command v-highlight will not take effect.
// So, on this page, calling highlightCode() in the mounted() and updated() methods can solve the problem of code not highlighting

// import TrendingColumn from "./Trending";
// import InTheNews from "./InTheNews";
import hljs from 'highlight.js'

import EbookTest from './EbookTest'
