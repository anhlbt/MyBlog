<template>
  <div>
    ...
    <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
      <h3 class="h6 mb-0">
        <i class="icon-people g-pos-rel g-top-1 g-mr-5"></i> Comment list <small v-if="comments">(Total {{ comments._meta.total_items }} , {{ comments._meta.total_pages }} Page)</small>
      </h3>
