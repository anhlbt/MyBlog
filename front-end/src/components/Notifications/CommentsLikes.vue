  ...
  <div>
    ...
    <div class="card border-0 g-mb-15">
      ...
      <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
        <h3 class="h6 mb-0">
          <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> Recived Comments Likes <small v-if="likes">(Total {{ likes._meta.total_items }} Article, {{ likes._meta.total_pages }} Page)</small>
        </h3>
      ...
      <div v-if="likes" class="card-block g-pa-0" >
        ...
        <div class="media g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-20"
          ...
          <div class="media-body">
            <div class="g-mb-15">
              <h5 class="h5 g-color-gray-dark-v1 mb-0"><router-link v-bind:to="{ path: `/user/${like.user.id}` }" class="comment-author g-text-underline--none--hover">{{ like.user.name || like.user.username }}</router-link> <span class="h6">Like you <router-link v-bind:to="{ path: `/post/${like.comment.post.id}#c${like.comment.id}` }" class="g-text-underline--none--hover"> comment </router-link></span></h5>
              <span class="g-color-gray-dark-v4 g-font-size-12">{{ $moment(like.timestamp).format('YYYY/MM/DD HH:mm:ss') }}</span>
            </div>

            <div v-if="like.comment.disabled" class="g-color-red g-mb-15">This comment contains bad information and has been suppressed.</div>
            <div v-else>
            ...
            <ul class="list-inline d-sm-flex my-0">
              <li v-if="!like.comment.disabled" class="list-inline-item g-mr-20">
                <span class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover">
                  ...
                  <span> {{ like.comment.likers_id.length }} Like</span>
                </span>
              </li>
