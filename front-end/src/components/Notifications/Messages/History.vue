...
<div>
      ...
      <div class="dropdown g-mb-10 g-mb-0--md">
        ...
        <div class="dropdown-menu dropdown-menu-right rounded-0 g-mt-10">
          ...
          <router-link v-bind:to="{ name: 'MessagesIndex' }" class="dropdown-item g-px-10">
            <i class="icon-plus g-font-size-12 g-color-gray-dark-v5 g-mr-5"></i> Return to private message list
          </router-link>
  ...
  <form id="replyMessageForm" @submit.prevent="onSubmitReply" @reset.prevent="onResetReply" class="g-mb-40">
    <div class="form-group">
      <textarea v-model="replyMessageForm.body" class="form-control" id="replyMessageFormBody" rows="5" placeholder=" Whisper..."></textarea>
